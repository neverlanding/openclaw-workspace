...
# API配置 - 从环境变量或默认值读取
AK = os.getenv("VOLCENGINE_AK", "AKLTYTgwYjQ1YjA0OWRiNGVlZGIwMGQyNTEyYmE0NmQ5Zjc")
SK = os.getenv("VOLCENGINE_SK", "d53bb79a5746412fa36d92e157808b28")
...
def generate_image(prompt, model="doubao-seedream-3.0-t2i", size="1024x1024", seed=-1):
    ...
    # 火山引擎Ark API使用API Key作为Bearer Token
