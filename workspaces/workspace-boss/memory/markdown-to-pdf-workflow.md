# ⚠️ 【已过期】Markdown 文件创建与飞书发送技巧

**状态**: 【已过期】❌  
**原因**: 路径规则已更新，请参考公用记忆 `shared-memory/markdown-to-pdf-workflow.md`  
**时间**: 2026-03-07（旧版）

---

> 🚨 **注意**：本文件内容已过时，media/browser/ 路径已废弃！  
> 最新规则：默认直接发送，失败时复制到自己 workspace 的 tmp/ 目录
